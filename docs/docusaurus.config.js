    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/your-username/push-notification-service/tree/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Push Notification Service',
        logo: {
          alt: 'Push Notification Service Logo',
          src: 'img/logo.svg',
        },
        items: [
          {
          ...
          {
            href: 'https://github.com/longvv/push-notification-service',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'GitHub Issues',
                href: 'https://github.com/longvv/push-notification-service/issues',
              },
            ],
          },
        ],
